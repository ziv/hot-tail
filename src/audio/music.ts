...
export const SONGS: Record<string, Song> = {
  ...
  city: {
    bpm: 128,
    roots: [45, 45, 41, 41, 48, 48, 43, 40],
    kick: 'x...x...x...x...',
    snare: '....x.......x...',
    hat: '..x...x...x...x.',
    bass: 'x.xxx.xxx.xxx.xo',
    guitar: '................',
    lead: [
  ...
  strato: {
    ...
    lead: [
      ...
      'C6:4 B5:4 G5:8',
      'B5:2 D6:2 G6:4 F#6:4 D6:4',
      'E6:12 -:4',
      'G6:4 F#6:2 E6:2 D6:4 B5:4',
      'C6:4 E6:4 G5:8',
      'A5:2 B5:2 D6:4 C6:4 A5:4',
      'B5:8 D#6:4 F#6:4',
    ],
  },
  finalBoss: {
    bpm: 176,
    roots: [40, 41, 40, 38, 40, 41, 43, 47],
    kick: 'xxx.x.x.xxx.x.x.',
    snare: '....x.......x.xx',
    hat: 'xxxxxxxxxxxxxxxx',
    bass: 'xxxxxxxxxxxxxxxx',
    guitar: 'x.xx.xx.x.xx.xx.',
    lead: [
      'E5:2 F5:2 E5:2 B5:2 C6:4 B5:4',
      'F5:2 G5:2 A5:4 G5:4 F5:4',
      'E5:2 B5:2 E6:4 D6:4 B5:4',
      'D5:4 F5:4 A5:8',
      'E6:4 D6:2 C6:2 B5:4 A5:4',
      'F5:4 A5:4 C6:8',
      'G5:2 B5:2 D6:4 F6:4 D6:4',
      'D#6:8 F#6:4 B6:4',
    ],
  },
  ending: {
  ...
  desert: {
    bpm: 156,
    roots: [40, 40, 43, 45, 40, 40, 38, 47],
    kick: 'x..x..x...x.x...',
    snare: '....x.......x...',
    hat: 'x.xxx.xxx.xxx.xx',
    bass: 'x.x.xox.x.x.xox.',
    guitar: 'x..x..x.x..x..x.',
    lead: [
      'E5:2 G5:2 A5:4 B5:4 A5:2 G5:2',
      'E5:6 D5:2 E5:8',
      'G5:2 A5:2 B5:4 D6:4 B5:4',
      'A5:8 -:4 B5:2 C6:2',
      'B5:4 A5:2 G5:2 E5:4 G5:4',
      'A5:4 G5:2 E5:2 D5:8',
