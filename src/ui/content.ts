...
export const TIPS = [
  ...
  'Boost outruns enemy fire; the air-brake makes tail-chasers overshoot into your sights.',
  ...
  <div class="controls-grid">
    <div>
      ...
      <table>
        ...
        <tr><td>Boost / air-brake</td><td>Shift or E / Q or Z</td></tr>
    ...
    <div>
      ...
      <table>
        ...
        <tr><td>Boost / air-brake</td><td>RT / LT</td></tr>
